...
public class HeightProfileGenerator {
    ...
    private static Logger logger = Logger.getLogger(HeightProfileGenerator.class);

    public List<List<Double>> generateFlotSeries(List<String> trackWkts){
        ...
        try{
            for(String trackwkt:trackWkts){
                //trackwkt = trackwkt.replaceFirst("SRID=900913;","");
